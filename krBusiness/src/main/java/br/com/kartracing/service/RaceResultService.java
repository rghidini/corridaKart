...
@Service
public class RaceResultService implements IRaceResult{

	private static final Logger logger = Logger.getLogger(RaceResultService.class);
	private static final Integer FOURTH_TURN = Integer.valueOf(4);

	@Autowired
	private IReadLogFile raceRecord;
